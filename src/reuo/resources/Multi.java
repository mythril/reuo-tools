...
/**
 * A structural arrangement of bitmaps. Each sprite is a {@link Multi.Cell Cell}
 * that has a location relative to this Structure and an identifier for a
 * sprite. <h3>Dimensions</h3> A structure exists in 3-space. The size along the
 * x-axis is the <i>width</i>
 * 
